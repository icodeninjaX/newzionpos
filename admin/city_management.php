        ...
        <ul>
            ...
            <li>
                <details style="font-size: 12px; color: white; font-weight: bold; padding-top: 5px;">
                    ...
                    <ul>
                        <li class="active"><a href="city_management.php">City Management</a></li>
                    ...
                    <div class="col-md-4">
                        ...
                        <form id="add-city-form">
                            <div class="mb-3" style="display:flex; justify-content: space-between; align-items:stretch;">
                                <input type="text" class="form-control" id="city_name" placeholder="Enter City Name" required autocomplete="off">

...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li class="active"><a href="city_management.php" style="font-size: 17px;" class="ordermanagement"><img
        ...
        <div class="main-content">
            <div class="">
                <h1
                    ...
                    <img src="img/location-management.png" alt="Orders" class="order-img">City Management</h1>
                <div class="container">
                    <div class="col-md-4">
                        <h3>Add City</h3>

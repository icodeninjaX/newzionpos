            ...
            <li>
                <details style="font-size: 12px; color: white; font-weight: bold; padding-top: 5px;">
                    ...
                    <ul>
                        ...
                        <li  class="active"><a href="street_management.php">Street Management</a></li>
                    </ul>
                </details>
            </li>
        </ul>
                    ...
                    <div class="col-md-4">
                        ...
                        <form id="add-street-form">
                            <div class="mb-3" style="display: flex; justify-content: space-between; align-items: stretch;">
                                ...
                                <input type="text" class="form-control" id="street_name" required placeholder="Enter Street name">

...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li class="active"><a href="subdivision_management.php" style="font-size: 16px;" class="ordermanagement"><img
        ...
        <div class="main-content">
            <div class="">
                <h1
                    ...
                    <img src="img/location-management.png" alt="Orders" class="order-img">Subdivision Management
                </h1>
                <div class="container">
                    <div class="col-md-4">

...
<body>
  ...
  <main>
    ...
    if (mysqli_num_rows($result) > 0) {
      ...
      echo "<table>";
      echo "<tr><th>#</th><th>ID</th><th>First name</th><th>Last name</th><th>Complete Address</th>
      <th>Contact #</th><th>Landmark</th><th>Tank Type</th><th>Branch</th></tr>";
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td class='address'>" . $row['cus_address'] . ' '  .  $row['street'] . ' ' . $row['subdivision'] . ' ' . $row['barangay'] . ' ' . $row['city'] . "</td>";
